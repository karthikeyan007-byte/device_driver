...
// Sysfs write function to trigger the interrupt
...
static int __init etx_driver_init(void) {
    ...
    printk(KERN_INFO "Initializing ETX Interrupt Driver\n");
    ...
    printk(KERN_INFO "ETX Interrupt Driver Initialized Successfully!\n");
    return 0;
}
...
static void __exit etx_driver_exit(void) {
    ...
    printk(KERN_INFO "ETX Interrupt Driver Unloaded\n");
}
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Karthikeyan (Updated by ChatGPT)");
MODULE_DESCRIPTION("Interrupt Example Driver with Sysfs and IRQ Counter");
